...
既定の 1 点（$R = 12.5$）では次のとおりで、誤差は約 1.1% です。

| 量 | 理論 $\sigma/R$ | 測定 $\Delta p$ | 相対誤差 |
| --- | ---: | ---: | ---: |
| 圧力差 | $8.00\times10^{-6}$ | $7.91\times10^{-6}$ | 1.13% |
...
| ---: | ---: | ---: | ---: | ---: |
| 8.0 | 0.12500 | $1.250\times10^{-5}$ | $1.150\times10^{-5}$ | 8.00% |
| 10.0 | 0.10000 | $1.000\times10^{-5}$ | $9.820\times10^{-6}$ | 1.80% |
| 12.5 | 0.08000 | $8.000\times10^{-6}$ | $7.910\times10^{-6}$ | 1.13% |
| 15.0 | 0.06667 | $6.667\times10^{-6}$ | $6.560\times10^{-6}$ | 1.60% |
| 17.0 | 0.05882 | $5.882\times10^{-6}$ | $5.780\times10^{-6}$ | 1.74% |
