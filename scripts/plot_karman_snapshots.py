...
if variant not in ('pure', 'keps', 'les', 'des'):
...
if variant == 'pure':
    ...
    src_dir = ROOT_DIR / 'outputs' / 'sec4' / 'karman_des'
    prefix = 'karman_des_snapshot_'
    suptitle_label = 'LBM + SA-DES'
    out_fname = 'karman_snapshots_des.png'
