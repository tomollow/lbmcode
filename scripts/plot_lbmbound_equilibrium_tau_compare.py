...
def run_case(executable: Path, tau: float) -> Path:
    output_dir = OUTPUT_DIR / f"lbmbound_equilibrium_tau_{str(tau).replace('.', '_')}"
...
def main() -> None:
    ...
    profile_axis.set_title("Equilibrium 境界での定常速度分布比較")
    ...
    output_path = OUTPUT_DIR / "lbmbound_equilibrium_tau_compare.png"
    published_path = PUBLISHED_ASSET_DIR / "lbmbound_equilibrium_tau_compare.png"
